...
```
pkgs <-  c( "broom", "car", "emmeans", "Epi", "fivethirtyeight", "GGally", "ggdist", "ggpubr", "glue", "gt", "haven", "infer",
            "janitor", "knitr", "medicaldata", "mice", "MKinfer", "naniar", "nhanesA", "olsrr", "palmerpenguins", "patchwork",
