...
```
pkgs <-  c( "broom", "broom.mixed", "car", "emmeans", "Epi", "fivethirtyeight", "GGally", "ggdist", "ggpubr", "glue", "gt",
            "haven", "infer", "janitor", "knitr", "medicaldata", "mice", "MKinfer", "naniar", "nhanesA", "olsrr",
